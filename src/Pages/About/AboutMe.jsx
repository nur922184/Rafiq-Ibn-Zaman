            ...
            <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        Hello! I’m Rafiq Ibn Zaman, a dedicated  Front-end  Developer with a strong focus on creating functional and visually appealing websites. From custom themes to plugin development, I deliver solutions that are secure, responsive, and tailored to client needs. My goal is to blend creativity with technical expertise
