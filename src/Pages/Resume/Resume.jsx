...
const Resume = () => {
  const resumeLink = "https://drive.google.com/file/d/1OsT-obAI4eJsWI6AnzcTeWTPI4XtBx1d/view";
  const downloadLink = "https://drive.google.com/uc?export=download&id=1OsT-obAI4eJsWI6AnzcTeWTPI4XtBx1d";
